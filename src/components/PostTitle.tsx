    ...
    return (
        <div className="md:min-h-screen">
            <div className="h-[60vh] md:h-[95vh] w-full m-auto relative flex flex-col-reverse">
                <div className="w-full h-full bg-slate-300 absolute -z-10 top-0 bg-fixed brightness-[.35]" style={{ backgroundImage: `url(${imgUrl})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
